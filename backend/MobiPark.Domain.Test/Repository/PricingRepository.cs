...
public class PricingRepository : IPricingRepository
{
    ...
    public PricingRepository()
    {
        ...
        {
            new() { Vehicle = new Car("Toyota", new FrLicensePlate("AB-123-CD"), new ThermalEngine()), Price = 5 },
            new()
            {
                Vehicle = new Motorcycle("Toyota", new FrLicensePlate("DE-456-FG"), new ThermalEngine()), Price = 3
            }
        };
    }
    ...
    public Pricing GetPricing(string vehicleType)
    {
        ...
        if (pricing == null) throw new PricingNotFoundException(vehicleType);
    ...
    public double CalculatePrice(Vehicle vehicle, DateTime startTime, DateTime endTime, bool isElectricCharging)
    {
        ...
        if (pricing == null) throw new PricingNotFoundException(vehicleTypeName);

        var price = pricing.Price;
        if (isElectricCharging) price += 2;
